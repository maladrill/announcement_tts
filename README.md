...
```
### What?
Announcement OpenAI TTS - it doesnt replace th TTS module.
Plays back one of the system recordings generated by openAI from your text (optionally allowing the user to skip it) and then goes to another destination.
...
Then download this module from https://github.com/maladrill/announcement_tts/archive/refs/heads/main.zip and install it in Admin -> Module Admin -> Upload modules

### TODO
Fix the playback of the recordings
...
### Copyright SQS Polska: https://sqspolska.pl
