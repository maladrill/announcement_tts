...
<?php
// Handle edit mode – load record by ID if provided
$request    = $_REQUEST;
...
<form class="fpbx-submit"
  ...
  <div class="element-container">
    <div class="form-group row">
      ...
      <div class="col-md-9">
        ...
        <span class="help-block fpbx-help-block"><?php echo _("The name of this announcement.") ?></span>
      </div>
    </div>
  </div>
  ...
  <div class="element-container">
    <div class="form-group row">
      ...
      <div class="col-md-9">
        ...
        <span class="help-block fpbx-help-block"><?php echo _("Enter the text to be converted into speech.") ?></span>
      </div>
    </div>
  </div>
  ...
  <!-- Language Selector -->
  <?php
  // List of supported languages (OpenAI TTS)
$LANGUAGES = [
  ...
  <div class="element-container">
    <div class="form-group row">
      <div class="col-md-3"><label for="language" class="control-label"><?php echo _("Language") ?></label></div>
      <div class="col-md-9">
        <select id="language" name="language" class="form-control"><?php echo $langopts ?></select>
        <span class="help-block fpbx-help-block"><?php echo _("Language used for text-to-speech.") ?></span>
      </div>
    </div>
  </div>
  ...
  <!-- Voice Selector -->
  <?php
  // List of available OpenAI voices
  $VOICES = ['alloy','ash','ballad','coral','echo','fable','nova','onyx','sage','shimmer'];  $voiceopts = '';
  foreach ($VOICES as $v) {
  ...
  <div class="element-container">
    <div class="form-group row">
      <div class="col-md-3"><label for="voice" class="control-label"><?php echo _("Voice") ?></label></div>
      <div class="col-md-9">
        <select id="voice" name="voice" class="form-control"><?php echo $voiceopts ?></select>
        <span class="help-block fpbx-help-block"><?php echo _("Voice model to use for speech synthesis.") ?></span>
      </div>
    </div>
  </div>

  <!-- Audio File Preview (if exists) -->
    ...
    <div class="form-group row">
      ...
      <div class="col-md-9">
        ...
        <span class="help-block fpbx-help-block">
          <?php echo _("Where to send the caller after the message has been played.") ?>
        </span>
      </div>
    </div>
  </div>
...
<!-- JavaScript list of announcement names for validation -->
<script>
<?php
