...
function checkAnnouncementtts(theForm) {
  ...
  if (isEmpty(theForm.description.value))
	...
	if (announcementttsnames.indexOf($("#description").val()) >= 0) {
				return warnInvalid($("#description"),_("Announcementtts Description Already Exist"));
	}
